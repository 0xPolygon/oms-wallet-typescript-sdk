...
By default, the connector validates OMS support with `omsWallet.supportedNetworks`. Pass `networks` only when you intentionally want a narrower or custom OMS network set for this connector instance.
